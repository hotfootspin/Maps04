...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([company  isEqual: @"Shell"])
        imgPath = [[NSBundle mainBundle] pathForResource:@"shell_logo" ofType:@"png"];
    else if ([company  isEqual: @"Chevron"])
        imgPath = [[NSBundle mainBundle] pathForResource:@"chevron-logo" ofType:@"png"];
    else if ([company  isEqual: @"KYSO"])
        imgPath = [[NSBundle mainBundle] pathForResource:@"kyso-logo-square" ofType:@"png"];
    else if ([company  isEqual: @"Esso"])
        imgPath = [[NSBundle mainBundle] pathForResource:@"esso-logo-square" ofType:@"png"];
    else if ([company  isEqual: @"Calso"])
        imgPath = [[NSBundle mainBundle] pathForResource:@"calso-logo" ofType:@"png"];
